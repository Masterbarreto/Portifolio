  ...
  return (
    <Link href={`/projects/${project.id}`}>
        ...
        <CardContent className="flex-grow">
            ...
            <p className="text-muted-foreground text-sm mb-4 line-clamp-3">{project.longDescription}</p>
        ...
        <CardFooter>
            <p className="text-sm text-primary font-semibold w-full">Ver detalhes do projeto &rarr;</p>
        </CardFooter>
        </Card>
    </Link>
  );
